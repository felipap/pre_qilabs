...
(function() {
  var Post, User, api, blog, blog_url, getPost, getTPostsWithTags, models, notify, posts, pushPosts, tags, tposts, _;
  ...
  getTPostsWithTags = function(tags, callback) {
  ...
  getPost = function(callback) {
    return pushPosts.pushNewPosts(function(err, data) {
      return posts = data;
    });
  };
