...
var watchId = navigator.geolocation.watchPosition(function onGetPosition (pos) {
	...
	$.fn.share = function (options) {
		...
		// /* If called on the global context. */
		// if ($(window).is(this)) {
		// 	$('body').on('mouseover', '[data-action=share]', function (e) {
		// 		console.log("porraa")
		// 		$(this).share();
		// 	});
		// 	$('body').on('click', '[data-action=share]', function (e) {
		// 		$(this).share();
		// 	});
		// 	return;
		// }
		...
		var extend = ((typeof _ !== 'undefined' && _)||$).extend;
