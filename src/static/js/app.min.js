...
define('common',['jquery','underscore', 'bootstrap','plugins'], function ($, _) {
...
define('timeline',['jquery', 'backbone', 'underscore', 'react', 'react.backbone'], function ($, Backbone, _, React) {
